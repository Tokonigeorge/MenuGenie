  ...
  return (
    <div className='min-h-screen flex flex-col bg-white'>
      ...
      <motion.div
        ...
        className='flex-1 flex items-center justify-center px-0 md:px-4'
      >
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.5, delay: 0.2 }}
          className='w-full max-w-md md:p-8 p-2  bg-white rounded-lg'
        >
          <div className='flex-1 flex items-center justify-center px-4'>
            <div className='w-full max-w-md md:p-8 p-2 bg-white rounded-lg '>
              <h1 className='text-center text-xl font-medium text-gray-800 mb-10'>
                Log into your Genie Account
              </h1>
              ...
              <form onSubmit={handleLogin}>
                ...
                <button
                  type='submit'
                  disabled={isLoading}
                  className='w-full mt-12 disabled:opacity-50 disabled:cursor-not-allowed bg-black text-white rounded-4xl py-2 px-4 flex items-center justify-center font-medium text-sm md:text-base cursor-pointer'
                >
              ...
              <button
                ...
                className='w-full border text-sm md:text-base disabled:opacity-50 disabled:cursor-not-allowed border-gray-900 text-gray-900 rounded-4xl py-2 px-4 flex items-center justify-center cursor-pointer'
              >
                <svg
                  className='w-5 h-5 md:mr-2 mr-1'
                  viewBox='0 0 24 24'
                  fill='none'
                  xmlns='http://www.w3.org/2000/svg'
                >
      ...
      <Toaster
        ...
        // autoClose={5000}
        // hideProgressBar
        // newestOnTop={false}  // Changed to false to maintain order
        // closeOnClick
        // rtl={false}
        // pauseOnFocusLoss
        // draggable={false}
        // pauseOnHover
        // theme="light"
        // limit={1}  // Add this to limit to 1 toast at a time
        // closeButton  // Simplified prop
        // toastStyle={{
