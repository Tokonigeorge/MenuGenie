            ...
            <div className='w-full max-w-md md:p-8 p-2 bg-white rounded-lg '>
              ...
              <form onSubmit={handleSignUp}>
                ...
                <button
                  type='submit'
                  disabled={isLoading}
                  className='w-full mt-12 disabled:opacity-50 disabled:cursor-not-allowed bg-black text-white rounded-4xl py-2 px-4 flex items-center justify-center font-medium cursor-pointer text-sm md:text-base'
                >
